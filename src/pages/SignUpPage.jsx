    ...
    <div className="min-h-screen relative flex items-center justify-center p-4">
      ...
      <div className="relative z-10 glass-effect rounded-2xl p-8 w-full max-w-md shadow-2xl animate-slide-up">
        <div className="text-center mb-6">
          ...
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Sign-Up for Localynk</h2>
          <p className="text-gray-600">Link up with local businesses</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center gap-2">
            ...
            <label htmlFor="terms" className="text-sm text-gray-700">
              Agree To The <span className="text-primary hover:underline cursor-pointer">Terms And Conditions</span>
            </label>
          </div>
        ...
        <p className="text-center text-sm text-gray-700 mt-6 mb-6">
        ...
        <div className="flex justify-center gap-6">
          <button className="w-14 h-14 bg-white rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50">
            <Apple size={28} />
          </button>
          <button className="w-14 h-14 bg-white rounded-full border border-gray-300 flex items-center justify-center hover:bg-gray-50">
